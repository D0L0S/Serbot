...
USE serbot;
CREATE TABLE clients (id INT, name VARCHAR(20), ip_address VARCHAR(30), os VARCHAR(30), active VARCHAR(30));
CREATE TABLE users (id INT, first_name VARCHAR(20), last_name VARCHAR(20), email VARCHAR(30), client_id INT(10));
CREATE TABLE attacks (id INT, name VARCHAR(20), os VARCHAR(20), script_location VARCHAR(30))
